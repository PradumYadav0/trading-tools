          ...
          <div className="glass-panel" style={{ padding: '1.75rem', marginTop: '2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            {finalFilteredSignals.length === 0 ? (
              ...
              <div style={{ maxHeight: '400px', overflowY: 'auto', overflowX: 'auto', paddingRight: '0.25rem' }} className="signals-table-container">
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '1150px', fontSize: '0.85rem' }}>
                  <thead>
                    <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)', color: 'var(--text-secondary)' }}>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Time (IST)</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Exit Time</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Symbol</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Action</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Entry</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Exit Spot</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Target</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Stoploss</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Status</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>PnL (Pts)</th>
                      <th style={{ padding: '0.75rem 0.5rem', whiteSpace: 'nowrap' }}>Trade ID</th>
                      <th style={{ padding: '0.75rem 0.5rem', textAlign: 'center', whiteSpace: 'nowrap' }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
